        ...
        <html>
            ...
            <body>
                ...
                <nav className="navbar sticky-top navbar-dark  navbar-expand-md">
                    ...
                    <h3 className="display-4 titles">Add Employee</h3>

                    <form className="addForm" autoComplete="off">
                        <div className="form-group">
                            <label>Name</label>
                            <input type="text" className="form-control" required name="name" placeholder="Enter Name" onChange={(event) => {
                                setName(event.target.value);
                            }} />
                        </div>
                        <div className="form-group">
                            <label>Surname</label>
                            <input type="text" className="form-control" required name="surname" placeholder="Enter Surname" onChange={(event) => {
                                setSurname(event.target.value);
                            }} />
                        </div>
                        <div className="form-group">
                            <label>Email</label>
                            <input type="text" className="form-control" required name="email" placeholder="Enter Email" onChange={(event) => {
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" required name="email" placeholder="Enter Position" onChange={(event) => {
                                setPosition(event.target.value);
                            }} />
                        </div>
                        <div className="form-group">

                            <button type="submit" onClick={addToList} className="btn btn-info"><BsPlusCircle color={'green'} size={25} className="add_icon" /> Save</button>
